...
public class IncludeFile {
    private Source sourceObject = null;
    ...
    public static Tokenizer initIncludeFile(final Deque<IncludeFile> fileList,
        final Source sourceId, final Statementizer statementizer)
            throws FileNotFoundException, IOException
    {
        ...
        i.sourceObject = sourceId;
        i.restartCharsToBypass = 0;
        i.tokenizer = new Tokenizer(sourceId);
            ...
            throws FileNotFoundException, IOException, MMIOException
    {
        ...
        if (fileList.isEmpty())
            ...
            currI.tokenizer = new Tokenizer(currI.sourceObject, currI.restartCharsToBypass);
