...
public interface ProofVerifier {
     ...
     */
    void verifyAllProofs(MessageHandler messageHandler, Map<String, Stmt> stmtTbl);
     ...
     * @param stmtTbl Statement Table (map).
     */
    void verifyAllExprRPNAsProofs(MessageHandler messageHandler, Map<String, Stmt> stmtTbl);
