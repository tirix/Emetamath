...
public interface ProofVerifier {
     ...
     */
    void verifyOneProof(Theorem theorem) throws VerifyException;
     ...
     */
    void verifyAllProofs(MessageHandler messageHandler,
                         Map      stmtTbl);
     ...
     *  @param stmtTbl  Statement Table (map).
     */
    void verifyAllExprRPNAsProofs(MessageHandler messageHandler,
                                  Map      stmtTbl);
