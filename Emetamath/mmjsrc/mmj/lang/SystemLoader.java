...
public interface SystemLoader {
    ...
    Theorem addTheorem(String labelS, int column, String typS,
        List<String> symList, List<String> proofList, SourcePosition position, MessageHandler messageHandler)
        throws MMJException;
    ...
    Theorem addTheorem(String labelS, int column, String typS,
        ...
        MessageHandler messageHandler) throws MMJException;
     ...
     *             {@code mmj.lang.LangConstants.java})
     */
    void finalizeEOF(MessageHandler messageHandler, boolean prematureEOF)
        throws MMJException;
