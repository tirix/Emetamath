...
public class LogicalSystem implements SystemLoader {
	...
	private ArrayList<Theorem> incompleteTheorems;
        ...
        final SyntaxVerifier syntaxVerifier)
    {
        ...
        this.incompleteTheorems = new ArrayList<>();
     ...
     * @param messageHandler for error reporting
    ...
    public Theorem addTheorem(final String labelS, final int column,
        ...
        final List<String> proofList, final SourcePosition position, 
        ...
        final List<String> proofList) throws LangException
    {
        final Theorem theorem = new Theorem(seq, scopeDefList, symTbl, stmtTbl,
            labelS, -1, typS, symList, proofList, null, null);
    ...
    public Theorem addTheorem(final String labelS, final int column,
        ...
        final MessageHandler messageHandler) throws LangException
    {

        final Theorem theorem = new Theorem(seqAssigner.nextSeq(), scopeDefList,
            symTbl, stmtTbl, labelS, column, typS, symList, proofList,
            proofBlockList, getProofCompression(), position, messageHandler);
     ...
     * definition, level 0.)
     *
     * @param messageHandler Messages object to error reporting.
     ...
     *             {@code mmj.lang.LangConstants.java})
     */
    public void finalizeEOF(final MessageHandler messageHandler, final boolean prematureEOF)
        throws LangException
    {
        ...
        if (scopeLvl != 0)
            if (prematureEOF)
            	...
            	throw new LangException(LangConstants.ERRMSG_MISSING_END_SCOPE_AT_EOF);
    }
     ...
     * LogicalSystem.
     *
     * @param messageHandler {@code MessageHandler} object for reporting errors.
     * @throws VerifyException if an error occurred
     */
    public void verifyAllSyntax(final MessageHandler messageHandler)
        throws VerifyException
    {
        syntaxVerifier.parseAllFormulas(messageHandler, symTbl, stmtTbl, null);
    }
     ...
     * @throws VerifyException if an error occurred
     */
    public void verifyProofs(final MessageHandler messageHandler) throws VerifyException {
        proofVerifier.verifyAllProofs(messageHandler, stmtTbl);
    }
     ...
     * @throws VerifyException if an error occurred
     */
    public void verifyAllExprRPNAsProofs(final MessageHandler messageHandler)
        throws VerifyException
    {
        proofVerifier.verifyAllExprRPNAsProofs(messageHandler, stmtTbl);
    }
     ...
     */
    public List<Theorem> getIncompleteTheorems() {
    ...
    public void theoremLoaderRollback(final MMTTheoremSet mmtTheoremSet,
        final MMJException error, final MessageHandler messageHandler,
        final boolean auditMessages) throws TheoremLoaderException
    {
        ...
        try {
            ...
            if (seqAssigner != null)
                seqAssigner.rollback(mmtTheoremSet, messageHandler, auditMessages);
