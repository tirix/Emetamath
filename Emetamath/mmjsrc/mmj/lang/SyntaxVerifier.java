...
public interface SyntaxVerifier {
     ...
     */
    ParseTree parseFormula(MessageHandler messageHandler,
//  Stmt[] parseFormula(Messages    messages,
     ...
     * @return Array of Stmt containing RPN.
     */
    ParseTree parseOneStmt(MessageHandler messageHandler,
//  Stmt[] parseOneStmt(Messages messages,
     ...
     * @param symTbl Symbol Table (Map).
     * @param stmtTbl Statement Table (Map).
     * @param progress Progress object to monitor the progress of the parsing
     */
    void parseAllFormulas(MessageHandler messageHandler, Map<String, Sym> symTbl,
        Map<String, Stmt> stmtTbl, Progress progress);
     ...
     */
    boolean initializeGrammar(MessageHandler messageHandler, Map<String, Sym> symTbl,
