...
/*
 *  UtilConstants.java  0.10 08/01/2008
 *
 *  Nov-26-2005:
 ...
 *      - Trigger the ProofAssistantEditor
...
public class UtilConstants {
     ...
     *  the ProofAssistantEditor proof text area window.
     *
     ...
     *
     *  If 'yes', positions the ProofAssistantEditor proof text area
     ...
     *
     *  Provides a clue to the system about how big to make
     *  the ProofAssistantEditor error message text area window.
     *
     ...
     *  of ProofAssistantEditor is prompted during Save dialogs, and
     ...
     *                       file to be displayed at ProofAssistantEditor
     *                       startup. Must exist.
     *  <p>
     ...
     *  is performed *after* ProofAssistantEditor, the ProofAsstProofFolder
     ...
     *                                which is input via RunParm<br>
     *                                and also during use of<br>
     *                                ProofAssistantEditor<.) If no file<br>
     ...
     *  ProofAssistantEditor Edit/Reformat Proof - Swap Alt menu item
     *  is selected.
     *  <p>
     *
     *  <p><code>
...
//stoppedhere
    ...
    /**
     *  MAX_STATEMENT_PRINT_COUNT_DEFAULT = 99999.
     */
    ...
    public static final String ERRMSG_RUNPARM_FILE_NOT_FOUND_1 =
        "A-UT-0007 RunParmFile not found. Input file name = ";
    ...
    public static final String ERRMSG_RUNPARM_FILE_BOGUS_1 =
        "A-UT-0013 RunParmFile not found or otherwise bogus."
        + "Message returned by RunParmFile handlers follows: ";
    ...
    public static final String ERRMSG_BOOK_MANAGER_NOT_ENABLED_1 =
        "A-UT-0203 OutputBoss found BookManager not enabled when"
    ...
    public static final String ERRMSG_BOOK_MANAGER_NOT_ENABLED_2 =
        ...
        + " to the LoadFile RunParm to enabled the BookManager.";

    public static final String
                        ERRMSG_BOOK_MANAGER_SECTION_NBR_NOT_FOUND_1
                                  =
        "A-UT-0204 BookManager Section Number ";
    public static final String
    ...
    public static final String ERRMSG_PA_GUI_REQUIRES_GRAMMAR_INIT =
        "E-UT-0036 ProofAsstBoss did not run the ProofAssistantEditor as"
        + " requested. The ProofAssistantEditor RunParm should follow"
        ...
        + " prior to running the ProofAssistantEditor (for use in"
        + " unification)."
    ...
    public static final String ERRMSG_TMFF_REQUIRES_GRAMMAR_INIT =
        ...
        + " will prevent ProofAssistantEditor from running, among other"
    ...
    public static final String ERRMSG_WV_MGR_REQUIRES_GRAMMAR_INIT =
        ...
        + " running the ProofAssistantEditor.\nFor more information, see:"
        + " ..\\mmj2\\mmj2jar\\AnnotatedRunParms.txt."
        + "\nReview previous error messages to find the error.";
