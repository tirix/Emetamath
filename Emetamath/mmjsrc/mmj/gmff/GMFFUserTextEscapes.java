...
public class GMFFUserTextEscapes implements Comparable<GMFFUserTextEscapes> {
    ...
    public boolean areUserTextEscapesValid(
        final List<GMFFExportParms> exportParmsList, final MessageHandler messageHandler)
    {

        boolean valid = true;

        if (isExportTypeValid(exportParmsList, messageHandler)) {}
        else
            valid = false;

        if (isEscapePairListValid(messageHandler)) {}
        else
            valid = false;
     ...
     * @return true if valid otherwise false.
     */
    public boolean isEscapePairListValid(final MessageHandler messageHandler) {
