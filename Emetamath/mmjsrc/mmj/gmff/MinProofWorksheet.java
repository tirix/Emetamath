...
public class MinProofWorksheet {
    ...
    /**
     * {@code messageHandler} object stored here for convenience.
     */
     ...
     */
    public MinProofWorksheet(final MessageHandler messageHandler) {
    ...
    public void load(final String proofText) {
        ...
        try {
            ...
            setStructuralErrors(true);
            messageHandler.accumException(new GMFFException(e,
    ...
    /* friendly */List<String> tokenize(final String line) {
        ...
        try (final Tokenizer tokenizer = new Tokenizer(new StringSource(line, "Single line from proof worksheet")))
        {
    ...
    private void triggerEmptyProofError() {
        setStructuralErrors(true);
        messageHandler.accumMessage(GMFFConstants.ERRMSG_EMPTY_PROOF,
            getTheoremLabel());
    }

    private void triggerBogusLine1Error() {
        setStructuralErrors(true);
        messageHandler.accumMessage(GMFFConstants.ERRMSG_BOGUS_LINE_1,
            getTheoremLabel());
    }
    ...
    {
        setStructuralErrors(true);
        messageHandler.accumMessage(GMFFConstants.ERRMSG_WORK_STMT_LINE_START_ERROR,
    ...
    {
        setStructuralErrors(true);
        messageHandler.accumMessage(GMFFConstants.ERRMSG_INVALID_THEOREM_LABEL_ERROR,
