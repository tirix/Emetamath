...
public class ProofWorksheetCache {
     ...
     * 
     * @param messageHandler The {@code MessageHandler} object.
     * @return MinProofWorksheet either cached or newly loaded.
     * @throws GMFFException if errors found during loading.
     */
    public MinProofWorksheet loadMinProofWorksheet(final MessageHandler messageHandler)
        throws GMFFException
    {

        if (cachedMinProofWorksheet == null) {

            cachedMinProofWorksheet = new MinProofWorksheet(messageHandler);
