...
public abstract class GMFFExporter {
    ...
    /**
     * Get function to return the {@code MessageHandler} object.
     *
     * @return the {@code MessageHandler} object.
     */
    public MessageHandler getMessageHandler() {
        return gmffManager.getMessageHandler();
    }
        ...
        final String token, final String theoremLabel)
    {
        ...
        gmffManager.getMessageHandler().accumMessage(
        ...
        throws GMFFException
    {
        ...
        if (p.cachedMinProofWorksheet == null) {
            ...
            p.cachedMinProofWorksheet = new MinProofWorksheet(getMessageHandler());
