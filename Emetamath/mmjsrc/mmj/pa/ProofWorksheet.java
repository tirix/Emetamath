...
public class ProofWorksheet {
    ...
    public StepSelectorStore stepSelectorStore = null;
    ...
    public ProofWorksheet(final ProofAsstPreferences proofAsstPreferences,
        final MessageHandler messageHandler, final boolean structuralErrors,
    ...
    public void outputCursorInstrumentationIfEnabled() {
        if (proofAsstPreferences.outputCursorInstrumentation.get())
        	messageHandler.accumException(proofCursor
     ...
     * @return Proof Error Message Text area as String.
     */
    public static String getOutputMessageText(final MessageHandler messageHandler) {
    	return messageHandler.getOutputMessageText();
    }

    public static String getOutputMessageTextAbbrev(final MessageHandler messageHandler) {
    	return messageHandler.getOutputMessageTextAbbrev();
    }
