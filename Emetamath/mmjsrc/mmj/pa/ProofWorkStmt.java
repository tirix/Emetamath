...
public abstract class ProofWorkStmt {
    ...
    /**
     * A reference to the source of this statement, and its position within that source
     */
    ...
    public SourcePosition getPosition(int fieldId) {
    	int lineNbr = w.computeProofWorkStmtLineNbr(this);
        int colNbr1 = computeFieldIdCol(fieldId);
        int colNbr2 = computeFieldIdCol(fieldId+1);
        return new SourcePosition(w.proofTextTokenizer.getSourceId(), lineNbr, colNbr1, Math.max(1, colNbr2 - colNbr1));
    }
}
