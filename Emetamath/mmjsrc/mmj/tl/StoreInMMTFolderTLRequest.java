...
public class StoreInMMTFolderTLRequest implements TLRequest {
    ...
    public void doIt(final TheoremLoader theoremLoader,
        ...
        final MessageHandler messageHandler, final ProofAsst proofAsst)
            throws TheoremLoaderException
    {
        theoremLoader.storeInMMTFolder(proofWorksheet, logicalSystem, messageHandler,
            proofAsst);

        messageHandler.accumMessage(TlConstants.ERRMSG_STORE_IN_MMT_FOLDER_OK);
    }
}
